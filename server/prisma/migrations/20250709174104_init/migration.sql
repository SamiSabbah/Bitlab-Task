...
-- AddForeignKey
ALTER TABLE `AudioChunk` ADD CONSTRAINT `AudioChunk_recordingId_fkey` FOREIGN KEY (`recordingId`) REFERENCES `Recording`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
